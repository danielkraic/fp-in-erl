...
% no_repeat([X,Y|_]) when (X = rock and Y = scissors) or (X = scissors and Y = rock) ->
%     % next will be paper
%     scissors; 
% no_repeat([X,Y|_]) when (X = rock and Y = paper) or (X = paper and Y = rock) ->
%     % next will be scissors
%     -> rock; 
% no_repeat([X,Y|_]) when (X = scissors and Y = paper) or (X = scissors and Y = rock) ->
%     % next will be rock
%     -> paper. 
